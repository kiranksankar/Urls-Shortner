...
<div>
    ...
    <br></br>
        ...
        <br></br>
        <p>You can Shorten any url you like and can dowload the shortened url and the original url in <span className="red"> pdf format </span> and you can copy the shortened Urls for further purposes. You can shorten <a href="/upload">single link, multiple link</a>   and even links in a <span className="red"> <a href="/upload">CSV format </a></span> </p> 
